...
@Component({
  selector: 'app-visit-historic-list',
  templateUrl: './visit-historic-list.component.html',
  styleUrls: ['./visit-historic-list.component.css']
})
export class VisitHistoricListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.permissions.canActivate(['/agent-information/visit-historic-list']);
