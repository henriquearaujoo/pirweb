...
(function() {
        ...
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i,
            d = {
                ...
                domReady: function() {
                    ...
                    return function(b) {
                        function n() {
                            try { document.documentElement.doScroll("left") } catch (f) { setTimeout(n, 1); return }
                            a()
                        }
                        c.push(b);
                        ...
                        if (1 == c.length)
                            ...
                            b = !1;
                            try { b = !window.frameElement } catch (q) {}
    ...
    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) {
        ...
        return {
            ...
            on: function(b, d, g, h, k) {
                ...
                function q() { D.removeListener(b, d) }
                var f = a.call(this, b);
                ...
                parse: {
                    ...
                    border: function(a) {
                        ...
                        CKEDITOR.tools.array.forEach(a, function(a) {
                            if (!b.color) { var c = CKEDITOR.tools.style.parse._findColor(a); if (c.length) { b.color = c[0]; return } }
                            b.style ||
                ...
                switch (a) {
                                        ...
                                        if (H && CKEDITOR.dtd.$removeEmpty[r.getName()]) {
                                            ...
                                            if (d.test(u)) r = null;
                                                ...
                                                for (var y = r.$.getElementsByTagName("*"), v = 0, B; B = y[v++];)
                                                    if (!CKEDITOR.dtd.$removeEmpty[B.nodeName.toLowerCase()]) { r = null; break }
                                            r && (E = !!u.length)
                                        } else r = null;
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                            ...
                            l.evaluator = function(a) { return !t(a) && !F(a) };
    ...
    (function() {
        ...
        function b(a, c, e, g) {
            a: {
                null == g && (g = d(e));
                for (var k; k = g.shift();)
                    if (k.getDtd().p) { g = { element: k, remaining: g }; break a }
                g = null
            }
            if (!g) return 0;
    ...
    (function() {
        ...
        function f(a) {
            var b, c, d, e, f = {},
                t = 1;
            for (a = B(a); b = a.match(p);)(c = b[2]) ? (d = D(c, "styles"), e = D(c, "attrs"), c = D(c, "classes")) : d = e = c = null, f["$" + t++] = { elements: b[1], classes: c, styles: d, attributes: e }, a = a.slice(b[0].length);
            return f
        }
        ...
        CKEDITOR.filter.prototype = {
            allow: function(b, c, d) {
                ...
                } else if (CKEDITOR.tools.isArray(b)) { for (e = 0; e < b.length; ++e) l = this.allow(b[e], c, d); return l }
    ...
    (function() {
        ...
        function d(b, c, d, g) { var h, k; for (h in c)(k = b[h]) || (k = b[h] = new a), k.add(c[h], d, g) }
            ...
            return function(B, p, C, t) {
                ...
                if (!t.checkReadOnly()) {
                    ...
                    if (m = C) {
                        ...
                        C = B.editor.dataProcessor.toHtml(C, { context: null, fixForBody: !1, protectedWhitespaces: !!D, dontFilter: B.dontFilter, filter: B.editor.activeFilter, enterMode: B.editor.activeEnterMode });
                    ...
                    if (!B.dontMoveCaret) {
                        for (G = e(z); G && a(G) && !G.is(v.$empty);) {
                            if (G.isBlockBoundary()) z.moveToPosition(G, CKEDITOR.POSITION_BEFORE_END);
                                ...
                                if (f(G) && G.getHtml().match(/(\s|&nbsp;)$/g)) { Q = null; break }
                                Q = z.clone();
        ...
        CKEDITOR.on("instanceCreated", function(a) {
            ...
            c.on("contentDom", function() {
                ...
                if (CKEDITOR.env.ie || l) x ? h.attachListener(h, "beforedeactivate", a, null, null, -1) : h.attachListener(c, "selectionCheck", a, null, null, -1), h.attachListener(h, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function() {
                    c.lockSelection(q);
                    y = 1
                }, null, null, -1), h.attachListener(h, "mousedown", function() { y = 0 });
                        ...
                        if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) {
                            ...
                            u.on("mousedown", function(a) {
                                ...
                                if (a.getTarget().is("html") && a.$.y < u.$.clientHeight && a.$.x < u.$.clientWidth) {
                                    m = t.$.createTextRange();
                                    try { m.moveToPoint(a.$.clientX, a.$.clientY) } catch (d) {}
                                    w = m.duplicate();
                                    u.on("mousemove", b);
                                    p.on("mouseup", c);
                                    u.on("mouseup", c)
        ...
        CKEDITOR.dom.selection.prototype = {
                        ...
                        if (l) this.fake(l);
                            ...
                            if (x) {
                                ...
                                for (m = 0; m < b.length; m++) {
                                    ...
                                    try { F.setEnd(d.endContainer.$, d.endOffset) } catch (r) {
            ...
            removeAllRanges: function() {
                if (this.getType() != CKEDITOR.SELECTION_NONE) {
                    var a = this.getNative();
                    try { a && a[x ? "empty" : "removeAllRanges"]() } catch (b) {}
                    this.reset()
                }
            }
        }
            ...
            checkElementMatch: function(a, b) {
                ...
                if ("string" == typeof this.element ?
                    ...
                    if (c._length) {
                        for (var h in c)
                            if ("_length" != h)
                                if (d = a.getAttribute(h) || "", "style" == h ? J(c[h], d) : c[h] == d) { if (!b) return !0 } else if (b) return !1;
                        if (b) return !0
                    } else return !0
                }
                return !1
                ...
                if (n.type == CKEDITOR.NODE_ELEMENT) {
                    ...
                    if (!h && (q = n.getName(),
                        ...
                        if (q = !g && "div" == q) {
                            a: {
                                q = n.getChildren();
                                for (var f = 0, D = q.count(); f < D; f++) { var w = q.getItem(f); if (w.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[w.getName()]) { q = !0; break a } }
                                q = !1
                            }
                            q = !q
                        }
    ...
    */
    ...
    (function() {
            ...
            function c(a) {
                return {
                    ...
                    exec: function() {
                        ...
                        else try { a = b.document.$.execCommand(c, !1, null) } catch (d) { a = !1 }
        ...
        function A(b, a) {
            function c(b) { return CKEDITOR.tools.repeat("\x3c/p\x3e\x3cp\x3e", ~~(b / 2)) + (1 == b % 2 ? "\x3cbr\x3e" : "") }
        ...
        CKEDITOR.plugins.clipboard.dataTransfer = function(b, a) {
            ...
            if ("Text" != n) try { this.$.setData(n, this.id) } catch (c) {}
            ...
            CKEDITOR.tools.createClass({
                ...
                _: {
                    ...
                    markFirstDisplayed: function(a) {
                        for (var b = function(a) { return a.type == CKEDITOR.NODE_ELEMENT && "none" == a.getStyle("display") }, e = this._.getItems(), d, c, f = e.count() - 1; 0 <= f; f--)
            ...
            if (a.config.scayt_disableOptionsStorage) {
                ...
                a.config.scayt_disableOptionsStorage = function(a) {
                    for (var b = [], d = 0; d < a.length; d++) {
                        var c = a[d],
                            n = !!g(a, "options");
                        if (!g(e, c) || n && g(f, function(a) { if ("lang" === a) return !1 })) return;
        ...
        CKEDITOR.plugins.tabletools = {
            ...
            init: function(d) {
                ...
                b("cellProperties", new CKEDITOR.dialogCommand("cellProperties", f({
                    ...
                    requiredContent: "table",
                    contentTransformations: [
                        [{ element: "td", left: function(a) { return a.styles.background && e.background(a.styles.background).color }, right: function(a) { a.styles["background-color"] = e.background(a.styles.background).color } }, {
                            element: "td",
                            check: "td{vertical-align}",
                            left: function(a) { return a.attributes && a.attributes.valign },
                            right: function(a) {
                        ...
                        [{
                            element: "td",
                            check: "td{height}",
                            left: function(a) { return (a = a.attributes) && a["cke-row-height"] },
                            right: function(a) {
    ...
    CKEDITOR.tools.buildTableMap = function(q, r, B, v, w) {
        ...
        for (r = r || 0; r <= v; r++) {
            ...
            for (var t = -1, z = B; z <= (-1 === w ? q[r].cells.length - 1 : w); z++) {
                ...
                if (!p) break;
                for (t++; y[u][t];) t++;
                for (var A = isNaN(p.colSpan) ? 1 : p.colSpan, p = isNaN(p.rowSpan) ? 1 : p.rowSpan, x = 0; x < p && !(r + x > v); x++) { y[u + x] || (y[u + x] = []); for (var C = 0; C < A; C++) y[u + x][t + C] = q[r].cells[z] }
                t += A - 1;
                if (-1 !== w && t >= w) break
            }
        }
    ...
    (function() {
        ...
        function z(a, b, c) {
            a.on("beforeCommandExec", function(d) {-1 !== CKEDITOR.tools.array.indexOf(b, d.data.name) && (d.data.selectedCells = u(a.getSelection())) });
        ...
        q.prototype.insertRow = function(a, b, c) {
            ...
            for (var d = this.cells.first.$.cellIndex, e = this.cells.last.$.cellIndex, h = c ? [] : this.cells.all, m, l = 0; l < a; l++) m = D(c ? this.cells.all : h, b), m = CKEDITOR.tools.array.filter(m.find("td, th").toArray(), function(a) { return c ? !0 : a.$.cellIndex >= d && a.$.cellIndex <= e }), h = b ? m.concat(h) : h.concat(m);
            this.setSelectedCells(h)
        };
        q.prototype.insertColumn = function(a) {
            function b(a) { a = n(a); return a >= e && a <= h }
            if ("undefined" === typeof a) a = 1;
            else if (0 >= a) return;
        ...
        var F = {
            onPaste: function(a) {
                ...
                !h.length || 1 === h.length && !G(e.getRanges()[0]) && !l || l && !m || (h = h[0].getAscendant("table"), k = new q(u(e, h)), d.once("afterPaste", function() {
                    ...
                    t(d, a)
                }), m ? (a.stop(), l ? (k.insertRow(1, 1 === l, !0), e.selectElement(k.rows.first)) : (k.emptyCells(), t(d, k.cells.all)), a = k.getTableMap(), f = CKEDITOR.tools.buildTableMap(m), k.insertRow(f.length - a.length), k.insertColumn(b(f) - b(a)), a = k.getTableMap(), this.pasteTable(k, a, f), d.fire("saveSnapshot"), setTimeout(function() { d.fire("afterPaste") }, 0)) : (c(k.cells.first), d.once("afterPaste", function() {
                    d.fire("lockSnapshot");
